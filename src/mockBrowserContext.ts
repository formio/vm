...
export function mockBrowserContext() {
  ...
  if (!globalThis.document.documentElement) globalThis.document.documentElement = {};
  ...
  if (!globalThis.window.document) globalThis.window.document = globalThis.document;
  if (!globalThis.btoa)
