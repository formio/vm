...
import { nunjucksUtilsCode } from './nunjucks-utils';

const baseNunjucksCode = fs.readFileSync(
    path.join(__dirname, '../assets/nunjucks.min.js'),
    'utf8',
);
const nunjucksDateFilterCode = fs
    .readFileSync(
